...
const Template30: React.FC = () => {
  ...
  return (
    <div className="w-[210mm] min-h-[297mm] bg-white text-gray-900 p-12 font-sans">
      {/* Dot Pattern Header */}
      <header className="mb-10 pb-6 border-b border-dotted border-gray-300">
        <h1 className="text-4xl font-extralight mb-2">{profile?.name}</h1>
      ...
      {aboutMe && (
        <section className="resume-section mb-8">
          <p className="text-sm text-gray-700 leading-relaxed italic">{aboutMe}</p>
        </section>
      )}

      {workExperience.length > 0 && (
        <section className="resume-section mb-8">
          <h2 className="text-xs uppercase tracking-widest text-gray-400 mb-5 border-b border-dotted border-gray-300 pb-2">
            Work Experience
          </h2>
      ...
      <div className="grid grid-cols-2 gap-8">
        {skills.length > 0 && (
          <section>
            <h2 className="text-xs uppercase tracking-widest text-gray-400 mb-4 border-b border-dotted border-gray-300 pb-2">
              Skills
            </h2>
